...
class RecipeRepositoryImpl implements RecipeRepository {
  ...
  Future<void> addRecipe(Recipe recipe) async {
    ...
    final models = recipes.map((e) => RecipeModel(
      ...
      instructions: e.instructions, description: '', preparationTime: '',
    )).toList();
